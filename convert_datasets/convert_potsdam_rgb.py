...
def parse_args():
    ...
    parser.add_argument('--tmp_dir', default='./tmp', help='path of the temporary directory')
...
def clip_big_image(image_path, clip_save_dir, args, to_label=False):
    ...
    if to_label:
        ...
        image = sio.imread(image_path)[:, :, [2, 1, 0]]         # Blue-Green-Red
    ...
    for box in boxes:
        ...
        # sio.imsave(osp.join(clip_save_dir, f'{idx_i}_{idx_j}_{start_x}_{start_y}_{end_x}_{end_y}.png'),
        #            clipped_image.astype(np.uint8))
